var App = function () {
	...
	var handleDataTables = function () {
		...
		$('.datatable').each(function(){
			...
			length_sel.addClass('form-control input-sm'); length_sel.css({'padding-top':'1px','padding-bottom':'1px','height':'22px','line-height':'1','margin-top':'-1pt','margin-left':'2pt'});
		});
	}
	/*-----------------------------------------------------------------------------------*/
	/*	jqGrid
	...
	return {
        ...
        init: function () {
            ...
            if (App.isPage("index")) {
				...
				//handleGritter();	//Function to display Gritter notifications,根据登录cookies,显示相关的消息,暂时屏蔽
            }
            if (App.isPage("wsinfos")){
               //chart_revenue();
            }
