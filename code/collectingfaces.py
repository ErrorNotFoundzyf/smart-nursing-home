...
用法：
python collectingfaces.py --id 106 --imagedir employees
...
# 全局参数
audio_dir = '/home/reed/git-project/old_care_system/audios'
...
action_map = {'blink':'请眨眼', 'open_mouth':'请张嘴', 
              ...
              'look_right':'请看右边'}
# 如果不方便打开摄像头，则用视频模拟
video_path = '/root/Desktop/old_care_system/images/tests/videos/room_01.mp4'
#video_path = ''
if video_path:
