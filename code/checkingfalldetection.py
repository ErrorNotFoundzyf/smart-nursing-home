...
python checkingfalldetection.py --filename corridor_01.avi
'''
...
# 全局变量
model_path = '/root/Desktop/old_care_system/models/fall_detection.hdf5'
output_fall_path = '/root/Desktop/old_care_system/supervision/fall'
