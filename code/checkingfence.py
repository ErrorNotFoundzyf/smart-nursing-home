...
python checkingfence.py --filename yard_01.mp4
'''
...
# 全局变量
prototxt_file_path = '/root/Desktop/old_care_system/models/mobilenet_ssd/MobileNetSSD_deploy.prototxt'
...
model_file_path = '/root/Desktop/old_care_system/models/mobilenet_ssd/MobileNetSSD_deploy.caffemodel'
output_fence_path = '/root/Desktop/old_care_system/supervision/fence'
input_video = args['filename']
skip_frames = 30 # of skip frames between detections
python_path = '/root/anaconda3/bin/python3' # your python path

# 超参数
minimum_confidence = 0.80 # minimum probability to filter weak detections
